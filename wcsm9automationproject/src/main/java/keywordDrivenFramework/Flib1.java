...
public class Flib1 {
	//it is used to store generic reusable methods and all the generic reusable methods are nonstatic
	...
	public String readDataFromPropeerty(String propPath,String key) throws IOException
	{
